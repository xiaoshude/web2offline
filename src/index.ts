...
import { useSessionForHost } from './main/session';
...
app.on('ready', () => {
  ...
  const url = new URL(configJson.url || MAIN_WINDOW_WEBPACK_ENTRY);

  useSessionForHost(url.hostname);
  createWindow()
});
